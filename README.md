[![Build Status](https://dev.azure.com/Mobsites-US/Blazor%20Signature%20Pad/_apis/build/status/Build?branchName=master)](https://dev.azure.com/Mobsites-US/Blazor%20Signature%20Pad/_build/latest?definitionId=7&branchName=master)
...
A Blazor component that utilizes the Signature Pad javascript library to implement smooth signature drawing on a HTML5 canvas.
...
As for the non-C# implementation of this component library, obviously [Szymon Nowak](https://github.com/szimek)'s Signature Pad [docs](https://github.com/szimek/signature_pad) were consulted carefully. And it goes without saying (but I'm going to say it anyway), that Blazor Signature Pad would not be what it is...were it not for author's hard work beforehand on said library.
...
```shell
dotnet add package Mobsites.Blazor.SignaturePad --version 1.0.0
```
...
***Be sure to place this script tag below any _framework scripts needed by the Blazor application!**
